        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "oLanguage": {
                    ...
                    '</select> casos',
                    "sZeroRecords": "No hay casos para mostrar",
                    "oPaginate": {
                        "sPrevious": "Ant",
                        "sNext": "Sig"
                    },
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando casos desde el _START_ hasta el _END_ ( _TOTAL_ casos registrados)",
                    "sInfoFiltered": "(_MAX_ casos filtrados)",
                    "sInfoEmpty": "No hay casos para mostrar",
