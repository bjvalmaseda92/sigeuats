        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "oLanguage": {
                    ...
                    '</select> lugares de ingreso',
                    "sZeroRecords": "No hay lugares de ingreso para mostrar",
                    "oPaginate": {
                        "sPrevious": "Ant",
                        "sNext": "Sig"
                    },
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando lugares de ingreso desde el _START_ hasta el _END_ ( _TOTAL_ lugares de ingreso registrados)",
                    "sInfoFiltered": "(_MAX_ lugares de ingreso filtrados)",
                    "sInfoEmpty": "No hay lugares de ingreso para mostrar",
