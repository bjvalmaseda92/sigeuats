        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "oLanguage": {
                    ...
                    '</select> tipos de caso',
                    "sZeroRecords": "No hay tipos de caso para mostrar",
                    "oPaginate": {
                        "sPrevious": "Ant",
                        "sNext": "Sig"
                    },
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando tipos de caso desde el _START_ hasta el _END_ ( _TOTAL_ tipos de caso registrados)",
                    "sInfoFiltered": "(_MAX_ grupos de tipos de caso)",
                    "sInfoEmpty": "No hay grupos de tipos de caso",
